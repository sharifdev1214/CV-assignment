...
<div class="container mt-5 p-4 shadow bg-white rounded" style="max-width: 700px;">
    ...
    <div class="text-center mb-4">
        <img src="../images/mohtasim.jpg" 
             alt="Mohtasim Picture" 
             class="rounded-circle border"
             style="width: 150px; height: 150px; object-fit: cover;">
    </div>

    <h2 class="text-center mb-4">Curriculum Vitae Mohtasim</h2>
    <hr>
    ...
    <table class="table table-bordered">
        ...
        <tr>
            <th>Email ID</th>
            <td>232043@student.au.edu.pk</td>
        </tr>
        <tr>
            <th>Contact No</th>
            <td>0333-1234567</td>
        ...
        <tr>
            <th>Address</th>
            <td>H# 202, Street 2, I-10/4, Islamabad, Pakistan</td>
        </tr>
    </table>
    ...
    <table class="table table-striped">
        ...
        <tr>
            ...
            <td>PGC BlueArea Islamabad</td>
            <td>2021 - 2023</td>
        </tr>
        <tr>
            <td>Matriculation (Science)</td>
            <td>IMCB I-10/1, Islamabad</td>
            <td>2019 - 2021</td>
        </tr>
    </table>
