...
-->
    <h2 class="text-center mb-4">Curriculum Vitae Maryam</h2>
    <hr>
    ...
    <table class="table table-bordered">
        ...
        <tr>
            <th>Email ID</th>
            <td>maryam@student.au.edu.pk</td>
        </tr>
        <tr>
            <th>Contact No</th>
            <td>0333-1234567</td>
        ...
        <tr>
            <th>Address</th>
            <td>H# 123, Street 10, G-9/4, Islamabad, Pakistan</td>
        </tr>
    </table>
    ...
    <table class="table table-striped">
        ...
        <tr>
            ...
            <td>Bahria College Islamabad</td>
            <td>2019 ? 2021</td>
        </tr>
        <tr>
