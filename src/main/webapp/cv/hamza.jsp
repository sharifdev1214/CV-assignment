...
-->
    ...
    <table class="table table-bordered">
        ...
        <tr>
            <th>Email ID</th>
            <td>232039@students.au.edu.pk</td>
        </tr>
        <tr>
            <th>Contact No</th>
            <td>03435995390</td>
        ...
        <tr>
            <th>Address</th>
            <td>H# 13, Street 10, E-11/2, Islamabad, Pakistan</td>
        </tr>
    </table>
    ...
    <table class="table table-striped">
        ...
        <tr>
            <td>Intermediate (FSc Pre-Medical)</td>
            <td>Almadina model school and college</td>
            <td>2019 ? 2021</td>
        </tr>
        <tr>
            <td>Matriculation (Science)</td>
            <td>Almadina School</td>
            <td>2017 ? 2019</td>
        </tr>
    </table>
